...
#define ONE_VALUE_ENDIAN_TEMPLATE_NO_PARAMETERS(NAME, BITS) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val##BITS<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op)>> __##NAME() noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op)>{ (uint8_t)interpreter::op::NAME##_##BITS }; }
...
#define ONE_VALUE_ENDIAN_TEMPLATE_L_PARAMETER(NAME, BITS) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val##BITS<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val16<endianness>)>> __##NAME(interpreter::val16<endianness> value) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val16<endianness>)>{ (uint8_t)interpreter::op::NAME##_##BITS, value.half.lo.ui, value.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_S_PARAMETER(NAME, BITS) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val##BITS<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val8<endianness>)>> __##NAME(interpreter::val8<endianness> value) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val8<endianness>)>{ (uint8_t)interpreter::op::NAME##_##BITS, value.ui }; }

#define ONE_VALUE_ENDIAN_TEMPLATE_64_BIT_PARAMETER(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val64<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val64<endianness>)>> __##NAME(interpreter::val64<endianness> value) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val64<endianness>)>{ (uint8_t)interpreter::op::NAME##_64, value.half.lo.half.lo.half.lo.ui, value.half.lo.half.lo.half.hi.ui, value.half.lo.half.hi.half.lo.ui, value.half.lo.half.hi.half.hi.ui, value.half.hi.half.lo.half.lo.ui, value.half.hi.half.lo.half.hi.ui, value.half.hi.half.hi.half.lo.ui, value.half.hi.half.hi.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_32_BIT_PARAMETER(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val32<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val32<endianness>)>> __##NAME(interpreter::val32<endianness> value) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val32<endianness>)>{ (uint8_t)interpreter::op::NAME##_32, value.half.lo.half.lo.ui, value.half.lo.half.hi.ui, value.half.hi.half.lo.ui, value.half.hi.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_16_BIT_PARAMETER(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val16<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val16<endianness>)>> __##NAME(interpreter::val16<endianness> value) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val16<endianness>)>{ (uint8_t)interpreter::op::NAME##_16, value.half.lo.ui, value.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_8_BIT_PARAMETER(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val8<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val8<endianness>)>> __##NAME(interpreter::val8<endianness> value) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::val8<endianness>)>{ (uint8_t)interpreter::op::NAME##_8, value.ui }; }

#define ONE_VALUE_ENDIAN_TEMPLATE_TYPE_64_BIT_PARAMETERS(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val64<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val64<endianness>) * 2ui64>> __##NAME(interpreter::val64<endianness> value, interpreter::val64<endianness> _mask, interpreter::type _type) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val64<endianness>) * 2ui64>{ (uint8_t)interpreter::op::NAME##_64, (uint8_t)_type, _mask.half.lo.half.lo.half.lo.ui, _mask.half.lo.half.lo.half.hi.ui, _mask.half.lo.half.hi.half.lo.ui, _mask.half.lo.half.hi.half.hi.ui, _mask.half.hi.half.lo.half.lo.ui, _mask.half.hi.half.lo.half.hi.ui, _mask.half.hi.half.hi.half.lo.ui, _mask.half.hi.half.hi.half.hi.ui, value.half.lo.half.lo.half.lo.ui, value.half.lo.half.lo.half.hi.ui, value.half.lo.half.hi.half.lo.ui, value.half.lo.half.hi.half.hi.ui, value.half.hi.half.lo.half.lo.ui, value.half.hi.half.lo.half.hi.ui, value.half.hi.half.hi.half.lo.ui, value.half.hi.half.hi.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_TYPE_32_BIT_PARAMETERS(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val32<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val32<endianness>) * 2ui64>> __##NAME(interpreter::val32<endianness> value, interpreter::val32<endianness> _mask, interpreter::type _type) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val32<endianness>) * 2ui64>{ (uint8_t)interpreter::op::NAME##_32, (uint8_t)_type, _mask.half.lo.half.lo.ui, _mask.half.lo.half.hi.ui, _mask.half.hi.half.lo.ui, _mask.half.hi.half.hi.ui, value.half.lo.half.lo.ui, value.half.lo.half.hi.ui, value.half.hi.half.lo.ui, value.half.hi.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_TYPE_16_BIT_PARAMETERS(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val16<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val16<endianness>) * 2ui64>> __##NAME(interpreter::val16<endianness> value, interpreter::val16<endianness> _mask, interpreter::type _type) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val16<endianness>) * 2ui64>{ (uint8_t)interpreter::op::NAME##_16, (uint8_t)_type, _mask.half.lo.ui, _mask.half.hi.ui, value.half.lo.ui, value.half.hi.ui }; }
#define ONE_VALUE_ENDIAN_TEMPLATE_TYPE_8_BIT_PARAMETERS(NAME) template <interpreter::VALUE V, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V, interpreter::val8<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val8<endianness>) * 2ui64>> __##NAME(interpreter::val8<endianness> value, interpreter::val8<endianness> _mask, interpreter::type _type) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::type) + (uint64_t)sizeof(interpreter::val8<endianness>) * 2ui64>{ (uint8_t)interpreter::op::NAME##_8, (uint8_t)_type, _mask.ui, value.ui }; }

#define TWO_VALUE_ENDIAN_TEMPLATE_NO_PARAMETERS_CONVERT(NAME1, NAME2, BITS1, BITS2) template <interpreter::VALUE V1, interpreter::VALUE V2, std::endian endianness = std::endian::native> inline std::enable_if_t<std::is_same_v<V1, interpreter::val##BITS1<endianness>> && std::is_same_v<V2, interpreter::val##BITS2<endianness>>, std::array<uint8_t, (uint64_t)sizeof(interpreter::op)>> __##NAME1##_2_##NAME2() noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op)>{ (uint8_t)interpreter::op::NAME1##BITS1_2_##NAME2##BITS2 }; }

#define ENDIAN_TEMPLATE_ABI_TYPE_ARG_TYPE_ARG_COUNT_PARAMETERS(NAME) template <std::endian endianness = std::endian::native> inline std::shared_ptr<uint8_t[]> __##NAME(interpreter::abi_type _abi_type, const interpreter::arg_type* _arg_type, uint64_t _arg_count) { if (_arg_count >= 1ui64 && _arg_count <= 256ui64) { std::shared_ptr<uint8_t[]> data(new uint8_t[_arg_count + 3ui64]); data[0ui64] = (uint8_t)interpreter::op::NAME; data[1ui64] = (uint8_t)_abi_type; data[2ui64] = (uint8_t)(_arg_count - 1ui64); memcpy(&data[3ui64], _arg_type, (uint64_t)sizeof(interpreter::arg_type) * _arg_count); return data; } else throw std::runtime_error("Wrong argument count for NAME op assembler"); }
#define VARIADIC_VALUE_ENDIAN_TEMPLATE_ABI_TYPE_ARG_TYPE_PARAMETERS(NAME) template <std::endian endianness = std::endian::native, typename ...T> inline std::enable_if_t<std::conjunction_v<std::is_same<T, interpreter::arg_type>...> && ((uint64_t)sizeof...(T) >= 1ui64 && (uint64_t)sizeof...(T) <= 256ui64), std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::abi_type) + (uint64_t)sizeof(uint8_t) + (uint64_t)sizeof...(T) * (uint64_t)sizeof(interpreter::arg_type)>> __##NAME(interpreter::abi_type _abi_type, T... _arg_type) noexcept { return std::array<uint8_t, (uint64_t)sizeof(interpreter::op) + (uint64_t)sizeof(interpreter::abi_type) + (uint64_t)sizeof(uint8_t) + (uint64_t)sizeof...(T) * (uint64_t)sizeof(interpreter::arg_type)>{ (uint8_t)interpreter::op::NAME, (uint8_t)_abi_type, (uint8_t)((uint64_t)sizeof...(T) - 1ui64), interpreter::arg_type_val(_arg_type).__value.ui... }; }

#define DYNAMIC_STATIC_VARIADIC_VALUE_ENDIAN_TEMPLATE_ABI_TYPE_ARG_TYPE_PARAMETERS(NAME)	\
ENDIAN_TEMPLATE_ABI_TYPE_ARG_TYPE_ARG_COUNT_PARAMETERS(NAME)								\
VARIADIC_VALUE_ENDIAN_TEMPLATE_ABI_TYPE_ARG_TYPE_PARAMETERS(NAME)							\
...
namespace op_asm
{
	ONE_VALUE_ENDIAN_TEMPLATE_NO_PARAMETERS_64_32_16_8(and)
		...
		DYNAMIC_STATIC_VARIADIC_VALUE_ENDIAN_TEMPLATE_ABI_TYPE_ARG_TYPE_PARAMETERS(nativecall)
