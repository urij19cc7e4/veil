...
inline void nativecall::__cpy_obj(const nativecall& o)
{
	...
	for (uint64_t i = 0ui64; i < _arg_count; ++i)
		...
		else
		{
			...
			memcpy(_arg_val[i], o._arg_val[i], get_asize(_arg_io_type[i]));
		}

	uint64_t ret_val_size = get_rsize(_ret_io_type);
	_ret_val = (void*)new uint8_t[ret_val_size];
	memcpy(_ret_val, o._ret_val, ret_val_size);
...
inline ffi_abi nativecall::get_abi(abi_type type)
{
	switch (type)
	{
	case abi_type::NONE: return ffi_abi::FFI_DEFAULT_ABI;
	#ifdef __FFI_AIX
	case abi_type::AIX: return ffi_abi::FFI_AIX;
	#endif
	#ifdef __FFI_ARC64
	case abi_type::ARC64: return ffi_abi::FFI_ARC64;
	#endif
	#ifdef __FFI_ARCOMPACT
	case abi_type::ARCOMPACT: return ffi_abi::FFI_ARCOMPACT;
	#endif
	#ifdef __FFI_COMPAT_GCC_SYSV
	case abi_type::COMPAT_GCC_SYSV: return ffi_abi::FFI_COMPAT_GCC_SYSV;
	#endif
	#ifdef __FFI_COMPAT_LINUX
	case abi_type::COMPAT_LINUX: return ffi_abi::FFI_COMPAT_LINUX;
	#endif
	#ifdef __FFI_COMPAT_LINUX64
	case abi_type::COMPAT_LINUX64: return ffi_abi::FFI_COMPAT_LINUX64;
	#endif
	#ifdef __FFI_COMPAT_LINUX_SOFT_FLOAT
	case abi_type::COMPAT_LINUX_SOFT_FLOAT: return ffi_abi::FFI_COMPAT_LINUX_SOFT_FLOAT;
	#endif
	#ifdef __FFI_COMPAT_SYSV
	case abi_type::COMPAT_SYSV: return ffi_abi::FFI_COMPAT_SYSV;
	#endif
	#ifdef __FFI_DARWIN
	case abi_type::DARWIN: return ffi_abi::FFI_DARWIN;
	#endif
	#ifdef __FFI_EABI
	case abi_type::EABI: return ffi_abi::FFI_EABI;
	#endif
	#ifdef __FFI_EFI64
	case abi_type::EFI64: return ffi_abi::FFI_EFI64;
	#endif
	#ifdef __FFI_ELFBSD
	case abi_type::ELFBSD: return ffi_abi::FFI_ELFBSD;
	#endif
	#ifdef __FFI_FASTCALL
	case abi_type::FASTCALL: return ffi_abi::FFI_FASTCALL;
	#endif
	#ifdef __FFI_GNUW64
	case abi_type::GNUW64: return ffi_abi::FFI_GNUW64;
	#endif
	#ifdef __FFI_LINUX
	case abi_type::LINUX: return ffi_abi::FFI_LINUX;
	#endif
	#ifdef __FFI_LP64D
	case abi_type::LP64D: return ffi_abi::FFI_LP64D;
	#endif
	#ifdef __FFI_LP64F
	case abi_type::LP64F: return ffi_abi::FFI_LP64F;
	#endif
	#ifdef __FFI_LP64S
	case abi_type::LP64S: return ffi_abi::FFI_LP64S;
	#endif
	#ifdef __FFI_MS_CDECL
	case abi_type::MS_CDECL: return ffi_abi::FFI_MS_CDECL;
	#endif
	#ifdef __FFI_N32
	case abi_type::N32: return ffi_abi::FFI_N32;
	#endif
	#ifdef __FFI_N32_SOFT_FLOAT
	case abi_type::N32_SOFT_FLOAT: return ffi_abi::FFI_N32_SOFT_FLOAT;
	#endif
	#ifdef __FFI_N64
	case abi_type::N64: return ffi_abi::FFI_N64;
	#endif
	#ifdef __FFI_N64_SOFT_FLOAT
	case abi_type::N64_SOFT_FLOAT: return ffi_abi::FFI_N64_SOFT_FLOAT;
	#endif
	#ifdef __FFI_O32
	case abi_type::O32: return ffi_abi::FFI_O32;
	#endif
	#ifdef __FFI_O32_SOFT_FLOAT
	case abi_type::O32_SOFT_FLOAT: return ffi_abi::FFI_O32_SOFT_FLOAT;
	#endif
	#ifdef __FFI_OBSD
	case abi_type::OBSD: return ffi_abi::FFI_OBSD;
	#endif
	#ifdef __FFI_OSF
	case abi_type::OSF: return ffi_abi::FFI_OSF;
	#endif
	#ifdef __FFI_PA32
	case abi_type::PA32: return ffi_abi::FFI_PA32;
	#endif
	#ifdef __FFI_PA64
	case abi_type::PA64: return ffi_abi::FFI_PA64;
	#endif
	#ifdef __FFI_PASCAL
	case abi_type::PASCAL: return ffi_abi::FFI_PASCAL;
	#endif
	#ifdef __FFI_REGISTER
	case abi_type::REGISTER: return ffi_abi::FFI_REGISTER;
	#endif
	#ifdef __FFI_STDCALL
	case abi_type::STDCALL: return ffi_abi::FFI_STDCALL;
	#endif
	#ifdef __FFI_SYSV
	case abi_type::SYSV: return ffi_abi::FFI_SYSV;
	#endif
	#ifdef __FFI_THISCALL
	case abi_type::THISCALL: return ffi_abi::FFI_THISCALL;
	#endif
	#ifdef __FFI_UNIX
	case abi_type::UNIX: return ffi_abi::FFI_UNIX;
	#endif
	#ifdef __FFI_UNIX64
	case abi_type::UNIX64: return ffi_abi::FFI_UNIX64;
	#endif
	#ifdef __FFI_V8
	case abi_type::V8: return ffi_abi::FFI_V8;
	#endif
	#ifdef __FFI_V9
	case abi_type::V9: return ffi_abi::FFI_V9;
	#endif
	#ifdef __FFI_VFP
	case abi_type::VFP: return ffi_abi::FFI_VFP;
	#endif
	#ifdef __FFI_WASM32
	case abi_type::WASM32: return ffi_abi::FFI_WASM32;
	#endif
	#ifdef __FFI_WASM32_EMSCRIPTEN
	case abi_type::WASM32_EMSCRIPTEN: return ffi_abi::FFI_WASM32_EMSCRIPTEN;
	#endif
	#ifdef __FFI_WIN64
	case abi_type::WIN64: return ffi_abi::FFI_WIN64;
	#endif
	default: throw runtime_error(_err_msg_wrong_abit);
	}
}

inline uint64_t nativecall::get_asize(arg_type type)
{
	switch (type.outer)
	{
...
inline uint64_t nativecall::get_rsize(arg_type type)
{
	return max(get_asize(type), (uint64_t)sizeof(ffi_arg)) / (uint64_t)sizeof(uint8_t);
}
...
inline void nativecall::init()
{
	...
	_ret_val = (void*)new uint8_t[get_rsize(_ret_io_type)];
...
nativecall::~nativecall() noexcept
{
	__del_obj();
	__def_obj();
}
